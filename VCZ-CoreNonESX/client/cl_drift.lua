...
--   E D I T   --
-----------------
local driftmode = true -- on/off vitesse
local speed = kmh -- ou mph (KMH en Amérique)
local drift_speed_limit = 110.0 
local toggle = 118 -- Numpad 9 (Touche pour activer le driftmode)
